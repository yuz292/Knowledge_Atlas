...
def run_suite(config: SmokeConfig) -> SmokeReport:
    ...
    page_checks = [
        ...
        ("Topic heatmap shell", "ka_topic_heatmap_view.html", ["Topic Page (Heatmap View)", "Current heatmap atlas briefing", "paper_pnus"]),
        ("Topic full-facets shell", "ka_topic_full_facets_view.html", ["Topic Page (Full Facets)", "Current full-facet atlas briefing", "paper_pnus"]),
        ...
        ("Topic quick-lookup shell", "ka_topic_quick_lookup_view.html", ["Topic Page (Quick Lookup)", "Current quick-lookup atlas guide", "paper_pnus"]),
        ("Classic topics shell", "ka_topics.html", ["Topic Page (Classic View)", "Current atlas classic overview", "data/ka_payloads/topics.json"]),
